            ...
            <div class="container">
                <div class="row">
                    <div class="error-form">
                        ...
                        <p data-aos="fade-up" data-aos-delay="400" class="aos-init aos-animate">Sorry but the page you are looking for does not exist, have been<br /> removed, name changed or is temporarily unavailable.</p>
                        <div class="row">
