...
exports.checkBlogSearch = checkBlogSearch;
...
function checkBlogId(_x, _x2, _x3) {
  return _checkBlogId.apply(this, arguments);
} // kiểm tra data đầu vào cho search blog 
function _checkBlogId() {
  _checkBlogId = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var result;
...
function checkBlogSearch(_x4, _x5, _x6) {
  return _checkBlogSearch.apply(this, arguments);
}
function _checkBlogSearch() {
  _checkBlogSearch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var sortList, result;
