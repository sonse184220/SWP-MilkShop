...
var WishlistService = exports.WishlistService = /*#__PURE__*/function () {
  function WishlistService() {
    _classCallCheck(this, WishlistService);
  }
  return _createClass(WishlistService, [{
    key: "getWishlistRecord",
    value: // lấy 1 dòng thông tin wishlist (memberId và productId)
    function () {
      var _getWishlistRecord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, pid) {
        var _yield$poolConnect$qu, _yield$poolConnect$qu2, record;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              record = _yield$poolConnect$qu2[0];
      ...
      function getWishlistRecord(_x, _x2) {
        return _getWishlistRecord.apply(this, arguments);
      }
      return getWishlistRecord;
    }() // lấy cả danh sách wishlist bằng member ID
  }, {
    key: "getWishlistByMemberID",
    value: function () {
      var _getWishlistByMemberID = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
        var _yield$poolConnect$qu3, _yield$poolConnect$qu4, wishlist;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              wishlist = _yield$poolConnect$qu4[0];
      ...
      function getWishlistByMemberID(_x3) {
        return _getWishlistByMemberID.apply(this, arguments);
      }
      return getWishlistByMemberID;
    }() // thêm 1 product vô wishlist của 1 member
  }, {
    key: "addToWishlist",
    value: function () {
      var _addToWishlist = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id, pid) {
        var _yield$poolConnect$qu5, _yield$poolConnect$qu6, record;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _dbConnection.poolConnect.query("INSERT INTO wishlist (ProductID, UserID) VALUES (?, ?)", [pid, id]);
            case 2:
              _yield$poolConnect$qu5 = _context3.sent;
              _yield$poolConnect$qu6 = _slicedToArray(_yield$poolConnect$qu5, 1);
              record = _yield$poolConnect$qu6[0];
      ...
      function addToWishlist(_x4, _x5) {
