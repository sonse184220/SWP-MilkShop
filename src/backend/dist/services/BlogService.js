...
var BlogService = exports.BlogService = /*#__PURE__*/function () {
  function BlogService() {
    _classCallCheck(this, BlogService);
  }
  return _createClass(BlogService, [{
    key: "getBlog",
    value: // Lấy thông tin của 1 blog bằng ID
    function () {
      var _getBlog = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
        var _yield$poolConnect$qu, _yield$poolConnect$qu2, blog;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _dbConnection.poolConnect.query('SELECT * FROM blog WHERE BlogID = ?', [id]);
            case 2:
              _yield$poolConnect$qu = _context.sent;
              _yield$poolConnect$qu2 = _slicedToArray(_yield$poolConnect$qu, 1);
              blog = _yield$poolConnect$qu2[0];
