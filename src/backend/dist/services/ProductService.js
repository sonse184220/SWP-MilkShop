...
var ProductService = exports.ProductService = /*#__PURE__*/function () {
  function ProductService() {
    ...
    // 
    _defineProperty(this, "getAllProducts", function (callback) {
      var query = 'SELECT * FROM PRODUCT';
      _dbConnection.connection.query(query, function (err, results) {
  ...
  return _createClass(ProductService, [{
    key: "getProduct",
    value: // Lấy thông tin của 1 product bằng ID
    function () {
      var _getProduct = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
        var _yield$poolConnect$qu, _yield$poolConnect$qu2, product;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _dbConnection.poolConnect.query('SELECT * FROM product WHERE ProductID = ?', [id]);
            case 2:
              _yield$poolConnect$qu = _context.sent;
              _yield$poolConnect$qu2 = _slicedToArray(_yield$poolConnect$qu, 1);
              product = _yield$poolConnect$qu2[0];
