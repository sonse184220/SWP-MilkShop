...
var ProductController = exports.ProductController = /*#__PURE__*/function () {
  function ProductController() {
    ...
    _defineProperty(this, "getAllProducts", function (req, res) {
  ...
  return _createClass(ProductController, [{
    key: "getProductById",
    value: function () {
      var _getProductById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var id, product;
    ...
    value: function () {
      ...
      function searchProducts(_x3, _x4) {
