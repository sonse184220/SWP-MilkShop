...
var _blogValidators = require("../middlewares/blogValidators.js");
...
var router = exports.blogRoutes = (0, _express.Router)();
var blogController = new _BlogController.BlogController();
 ...
 */
router.get("/api/blogs/id/:id", _blogValidators.checkBlogId, /*#__PURE__*/function () {
 ...
 */
router.get("/api/blogs", /*#__PURE__*/function () {
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return blogController.searchBlogs(req, res);
        case 2:
        case "end":
