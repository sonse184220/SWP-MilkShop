...
var _memberValidators = require("../middlewares/memberValidators.js");
var _WishlistController = require("../controllers/WishlistController.js");
var _productValidators = require("../middlewares/productValidators.js");
...
var router = exports.wishlistRoutes = (0, _express.Router)();
var wishlistController = new _WishlistController.WishlistController();
 ...
 */
router.get("/api/wishlist/:id", _memberValidators.checkMemberId, /*#__PURE__*/function () {
 ...
 */
router.post("/api/wishlist/:id", _memberValidators.checkMemberId, _productValidators.checkProductIdInQuery, /*#__PURE__*/function () {
